...
dir_compressed_gfs=/lustre/scratch/twixtrom/gfs_compress_201607
...
dir_sub=/home/twixtrom/adaptive_WRF/control_WRF                         # submit to queue scripts
dir_log=${rootdir}/log                         # log directory
dir_store=/lustre/scratch/twixtrom/adaptive_wrf_save/control_thompson   # storage directory

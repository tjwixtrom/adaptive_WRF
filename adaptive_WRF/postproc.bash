...
mkdir -p /lustre/scratch/twixtrom/adaptive_wrf_post/adaptive_wrf_thomp_retro/${datem}

# Process for domain 1
echo 'Processing Domain 1'
infile1=/lustre/scratch/twixtrom/adaptive_wrf_save/adaptive_wrf_thomp_retro/${datem}/wrfout_d01_${datem}.nc
outfile1=/lustre/scratch/twixtrom/adaptive_wrf_post/adaptive_wrf_thomp_retro/${datem}/wrfprst_d01_${datem}.nc

${runscript} ${infile1} ${outfile1}

# Process for domain 2
echo 'Processing Domain 2'
infile2=/lustre/scratch/twixtrom/adaptive_wrf_save/adaptive_wrf_thomp_retro/${datem}/wrfout_d02_${datem}.nc
outfile2=/lustre/scratch/twixtrom/adaptive_wrf_post/adaptive_wrf_thomp_retro/${datem}/wrfprst_d02_${datem}.nc
